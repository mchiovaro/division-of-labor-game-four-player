...
public class PelletScript : MonoBehaviour
{
    ...
    public bool free_contact_on2 = false;
    public bool restrict_contact_on2 = false;
    ...
    private void OnTriggerEnter2D(Collider2D collider_)
    {
      ...
      if (collider_.tag.Equals("bee_free2")){
        ...
        my_colliders["bee_free2"] = true;
        free_contact_on2 = true;
      ...
      if (collider_.tag.Equals("bee_restricted2")){
        ...
        my_colliders["bee_restricted2"] = true;
        restrict_contact_on2 = true;
    ...
    private void tappedHandler2(object sender, EventArgs eventArgs)
    {
      ...
      if ((free_contact_on == true && beeFree.GetComponent<BeeTap>().grabbed_on == false && advanced_pellet == false) ||
          (restrict_contact_on == true && beeRestricted.GetComponent<BeeTap>().grabbed_on == false && advanced_pellet == false) ||
          (free_contact_on2 == true && beeFree2.GetComponent<BeeTap>().grabbed_on == false && advanced_pellet == false) ||
          (restrict_contact_on2 == true && beeRestricted2.GetComponent<BeeTap>().grabbed_on == false && advanced_pellet == false)
          )
      {

          // identify who is trying to grab the pellet
          if(free_contact_on == true && restrict_contact_on == false && free_contact_on2 == false && restrict_contact_on2 == false) grabber_base = 1;
          if(free_contact_on == false && restrict_contact_on == true && free_contact_on2 == false && restrict_contact_on2 == false) grabber_base = 2;
          if(free_contact_on == false && restrict_contact_on == false && free_contact_on2 == true && restrict_contact_on2 == false) grabber_base = 3;
          if(free_contact_on == false && restrict_contact_on == false && free_contact_on2 == false && restrict_contact_on2 == true) grabber_base = 4;
          ...
          if (scale_size < 1) // && transform.GetChild(avail_spawn[rand_ini]).position
          {
              ...
              if(grabber_base == 3)
              {
                saveToBuffer("3_TAPPED");
                beeFree2.GetComponent<TouchScript.Behaviors.Transformer>().enabled = false;
              }
              if(grabber_base == 4)
              {
                saveToBuffer("4_TAPPED");
                beeRestricted2.GetComponent<TouchScript.Behaviors.Transformer>().enabled = false;
              }
          ...
          if (scale_size > 1)
          {
                ...
                if(grabber_base == 3){
                  ...
                  // note that free bee grabbed on to the advanced pellets
                  beeFree2.GetComponent<BeeTap>().grabbed_on = true;
                  //Debug.Log("FREE GRABBED ON");
                  // log the pickup
                  saveToBuffer("3_PICKUP");
                  free_contact_on2 = false;
                  //Debug.Log("FREE CONTACT OFF");
                ...
                if(grabber_base == 4){
                  ...
                  // note that restricted bee grabbed on to the advanced pellets
                  beeRestricted2.GetComponent<BeeTap>().grabbed_on = true;
                  //Debug.Log("RESTRICT GRABBED ON");
                  // log the pickup
                  saveToBuffer("4_PICKUP");
                  restrict_contact_on2 = false;
                  //Debug.Log("RESTRICT CONTACT OFF");
    ...
    public void addToSequence(int tapped_shape, SpriteRenderer sp)
    {
        ...
        if(((free_contact_on == true && restrict_contact_on == false && free_contact_on2 == false && restrict_contact_on2 == false && beeFree.GetComponent<BeeTap>().grabbed_on == false) ||
            (restrict_contact_on == true && free_contact_on == false && free_contact_on2 == false && restrict_contact_on2 == false && beeRestricted.GetComponent<BeeTap>().grabbed_on == false) ||
            (free_contact_on2 == true && restrict_contact_on == false && free_contact_on == false && restrict_contact_on2 == false && beeFree2.GetComponent<BeeTap>().grabbed_on == false) ||
            (restrict_contact_on2 == true && free_contact_on == false && free_contact_on2 == false && restrict_contact_on == false && beeRestricted2.GetComponent<BeeTap>().grabbed_on == false))
            && from == left)
        {

          // identify who is trying to grab the pellet
          if(free_contact_on == true && restrict_contact_on == false && free_contact_on2 == false && restrict_contact_on2 == false)
          {
            grabber_advanced = 1;
          ...
          if(restrict_contact_on == true && free_contact_on == false && free_contact_on2 == false && restrict_contact_on2 == false)
          {
            grabber_advanced = 2;
          ...
          // identify who is trying to grab the pellet
          if(free_contact_on2 == true && restrict_contact_on == false && free_contact_on == false && restrict_contact_on2 == false)
          {
            grabber_advanced = 3;
            saveToBuffer("3_TAPPED_" + tapped_shape);
            beeFree2.GetComponent<TouchScript.Behaviors.Transformer>().enabled = false;

          }

          if(restrict_contact_on2 == true && free_contact_on == false && free_contact_on2 == false && restrict_contact_on == false)
          {
            grabber_advanced = 4;
            saveToBuffer("4_TAPPED_" + tapped_shape);
            beeRestricted2.GetComponent<TouchScript.Behaviors.Transformer>().enabled = false;
          }
          ...
          if (seqCorresponds && current_seq == CORRECT_SEQUENCE.Length)
          {
              ...
              // if it's bee free doing the work
              if(grabber_advanced == 3){

                // log the pick up
                saveToBuffer("3_PICKUP_MID");
              ...
              // if it's bee restrict doing the work
              if(grabber_advanced == 4){

                // log the pick up
                saveToBuffer("4_PICKUP_MID");
