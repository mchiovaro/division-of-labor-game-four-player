...
public class BeeTap : MonoBehaviour
{
    ...
    // define our objects
    GameObject work_row, drop_cells, spawn_cells, beeFree, beeRestrict, beeFree2, beeRestrict2;
    ...
    private void checkBoundaries()
    {
        ...
        if (GameObject.Find("player_blue_2").transform.position.y < field_bottom)
          GameObject.Find("player_blue_2").transform.position = new Vector3(GameObject.Find("player_blue_2").transform.position.x, field_bottom, GameObject.Find("player_blue_2").transform.position.z);
        if (GameObject.Find("player_red_2").transform.position.y < field_bottom)
          GameObject.Find("player_red_2").transform.position = new Vector3(GameObject.Find("player_red_2").transform.position.x, field_bottom, GameObject.Find("player_red_2").transform.position.z);
        ...
        if (GameObject.Find("player_blue_2").transform.position.y > field_top)
          GameObject.Find("player_blue_2").transform.position = new Vector3(GameObject.Find("player_blue_2").transform.position.x, field_top, GameObject.Find("player_blue_2").transform.position.z);
        if (GameObject.Find("player_red_2").transform.position.y > field_top)
          GameObject.Find("player_red_2").transform.position = new Vector3(GameObject.Find("player_red_2").transform.position.x, field_top, GameObject.Find("player_red_2").transform.position.z);
        ...
        if (GameObject.Find("player_blue_2").transform.position.x < field_left)
          GameObject.Find("player_blue_2").transform.position = new Vector3(field_left, GameObject.Find("player_blue_2").transform.position.y, GameObject.Find("player_blue_2").transform.position.z);
        if (GameObject.Find("player_red_2").transform.position.x < field_left)
          GameObject.Find("player_red_2").transform.position = new Vector3(field_left, GameObject.Find("player_red_2").transform.position.y, GameObject.Find("player_red_2").transform.position.z);
        ...
        if (GameObject.Find("player_blue_2").transform.position.x > field_right)
          GameObject.Find("player_blue_2").transform.position = new Vector3(field_right, GameObject.Find("player_blue_2").transform.position.y, GameObject.Find("player_blue_2").transform.position.z);
        if (GameObject.Find("player_red_2").transform.position.x > field_right)
          GameObject.Find("player_red_2").transform.position = new Vector3(field_right, GameObject.Find("player_red_2").transform.position.y, GameObject.Find("player_red_2").transform.position.z);
        ...
        if (ie_cond[round_num] == 1) {
           ...
           if (GameObject.Find("player_blue_2").transform.position.x <  barrier_right) {
                  GameObject.Find("player_blue_2").transform.position = new Vector3(barrier_right, GameObject.Find("player_blue_2").transform.position.y, GameObject.Find("player_blue_2").transform.position.z);
            }
        }
        ...
        if (ie_cond[round_num] == 2) {
           ...
           if (GameObject.Find("player_red_2").transform.position.x > barrier_left) {
                  GameObject.Find("player_red_2").transform.position = new Vector3(barrier_left, GameObject.Find("player_red_2").transform.position.y, GameObject.Find("player_red_2").transform.position.z);
            }
        }
